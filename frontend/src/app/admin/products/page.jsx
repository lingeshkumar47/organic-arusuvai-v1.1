...
export default function AdminProducts() {
  ...
  const [productVariants, setProductVariants] = useState([
    { name: '100g', price: 0, stock: 0 },
    { name: '250g', price: 0, stock: 0 },
    { name: '500g', price: 0, stock: 0 },
    { name: '1kg', price: 0, stock: 0 },
  ]);
  ...
  function resetForm() {
    setFormData({ name: '', slug: '', description: '', category_id: '', base_price: 0, is_active: true, is_featured: false });
    setSelectedImages([]);
    setPreviewImages([]);
    setExistingImages([]);
    setProductVariants([
            ...
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                ...
                <tr key={p.id} className="group hover:bg-gray-50/50 transition">
                  ...
                  <td className="px-6 py-4 font-bold text-gray-900">₹{p.base_price}</td>
                  <td className="px-6 py-4">
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                   ...
                   <div>
                     <label className="text-xs font-bold text-gray-400 uppercase tracking-widest block mb-2">Detailed Narration</label>
                     <textarea rows="4" value={formData.description} onChange={e => setFormData({...formData, description: e.target.value})} placeholder="Describe properties and farm origin..." className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-xl outline-none focus:border-primary-400 focus:bg-white transition" />
                   </div>
                   ...
                   <div className="grid grid-cols-2 gap-4">
                     ...
                     <div>
                       <label className="text-xs font-bold text-gray-400 uppercase tracking-widest block mb-2">Landing Price</label>
                       <div className="relative">
                         <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 font-bold">₹</span>
                         <input type="number" value={formData.base_price} onChange={e => setFormData({...formData, base_price: e.target.value})} className="w-full pl-8 pr-4 py-3 bg-gray-50 border border-gray-100 rounded-xl outline-none focus:border-primary-400 focus:bg-white transition" />
                       </div>
                     </div>
                   </div>
                   ...
                   <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100">
                      ...
                      <div className="space-y-3">
                         {productVariants.map((v, i) => (
                           <div key={i} className="flex items-center gap-2 bg-white p-2.5 rounded-xl border border-gray-100">
                             ...
                             <input type="number" placeholder="Price" value={v.price} onChange={e => {
                               ...
                               setProductVariants(copy);
                             }} className="w-20 px-2 py-1.5 border-b border-gray-100 text-xs outline-none" />
                         ...
                         {productVariants.length < 4 && (
                           <button onClick={() => setProductVariants([...productVariants, { name: '250g', price: 0, stock: 0 }])} className="text-[10px] font-bold text-primary-600 hover:underline">+ ADD ANOTHER VARIANT</button>
                         )}
                      </div>
                   </div>
