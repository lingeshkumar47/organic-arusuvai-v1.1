  ...
  const integrations = [
    {
      ...
      href: '/secureadmin/settings/google-oauth', status: 'Not Connected', statusColor: 'text-amber-600 bg-amber-50',
    },
    {
      icon: '💳', title: 'Razorpay Payment Gateway', desc: 'Accept UPI, cards, and net banking payments',
      href: '/secureadmin/settings/razorpay', status: 'Not Connected', statusColor: 'text-amber-600 bg-amber-50',
    },
    {
      icon: '💬', title: 'WhatsApp Business API', desc: 'Send order notifications and marketing broadcasts',
      href: '/secureadmin/settings/whatsapp', status: 'Not Connected', statusColor: 'text-amber-600 bg-amber-50',
    },
  ];
